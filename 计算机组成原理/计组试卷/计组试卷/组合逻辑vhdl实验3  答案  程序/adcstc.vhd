...
----------------------加入新指令adc和stc的操作码-------------
  CONSTANT ADC :STD_LOGIC_VECTOR(7 downto 0):="00100011";--NEW ADC
  CONSTANT STC :STD_LOGIC_VECTOR(7 downto 0):="00100010";--NEW STC
  ...
  begin
    ...
    if (Ir13='0')and(C_M='1')then
      case T_temp is
		...
		case T_temp is
			WHEN "0011"=>case instru is
						when ADC=>Comb:="100011000001"&Dr&Sr&"001010000000";  --adc
						when STC=>Comb:="10000100000000000000100000000000";--stc
						when others=>null;
						end case;
			when others=>null;
		end case;
